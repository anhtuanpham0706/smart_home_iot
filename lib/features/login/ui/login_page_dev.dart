      ...
      ListView(padding: EdgeInsets.zero, children: [
        ...
        Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              TextCustom('Đăng nhập', size: 24.sp,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ButtonCustomTransparent(forgotPassword,
                    TextCustom('Quên mật khẩu', size: 14.sp,
                        color: const Color(0xFFCB7120), weight: FontWeight.w500),
                    padding: EdgeInsets.all(5.sp)),
                ButtonCustomTransparent(signUp,
                    TextCustom('Đăng ký', size: 14.sp,
                        color: const Color(0xFFCB7120), weight: FontWeight.w500),
                    padding: EdgeInsets.all(5.sp)),
                 TextButton(onPressed: () => nextPage(), child: TextCustom('Bỏ qua', size: 14.sp, color: const Color(0xFFCB7120)))
